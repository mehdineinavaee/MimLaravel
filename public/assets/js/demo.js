...
(function ($) {
  ...
  $container.append(
    '<h5>تنظیمات قالب</h5><hr class="mb-2"/>' + "<h6>رنگ‌های نوار ناوبری</h6>"
  );
  ...
  let _sidebar_class = checkCookie("sidebar_class")
    ? getCookie("sidebar_class")
    : "sidebar-open";
  let _main_header_color = checkCookie("main_header_color")
    ? getCookie("main_header_color")
    : "navbar-dark bg-success";
  let _main_header_border = checkCookie("main_header_border")
    ? getCookie("main_header_border")
    : "border-bottom";
  let _main_sidebar_color = checkCookie("main_sidebar_color")
    ? getCookie("main_sidebar_color")
    : "sidebar-dark-info";
  let _logo_color = checkCookie("logo_color")
    ? getCookie("logo_color")
    : "bg-success";
  if (_main_header_border == "border-bottom")
    $(".control-sidebar input[type=checkbox]").attr("checked", true);
