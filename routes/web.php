...
Route::get('fetch-receipt-cheque', [ReceiptChequeController::class, 'fetchReceiptCheque']);
Route::get('fetch-pay-returning-cheque', [PayReturningChequeController::class, 'fetchPayReturningCheque']);
Route::get('fetch-cashing-cheque', [CashingChequeController::class, 'fetchCashingCheque']);
Route::get('fetch-cancel-cheque', [CancelChequeController::class, 'fetchCancelCheque']);
