...
class ReceiveFromTheAccountController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(ReceiveFromTheAccount $receiveFromTheAccount)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, ReceiveFromTheAccount $receiveFromTheAccount)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(ReceiveFromTheAccount $receiveFromTheAccount)
    {
        //
    }
}
