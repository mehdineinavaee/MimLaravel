...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('receive_miscellaneous_incomes', function (Blueprint $table) {
            $table->id();
            $table->string('income_title')->nullable(); // عنوان درآمد
    ...
    {
        Schema::dropIfExists('receive_miscellaneous_incomes');
    }
};
