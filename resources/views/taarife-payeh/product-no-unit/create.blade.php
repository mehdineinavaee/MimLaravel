    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createInfoLabel">واحد شمارش کالا جدید</h5>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="form-group mb-3">
                            <label for="add_code">کد واحد</label>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="form-group mb-3">
                            <div class="form-group mb-3">
                                <label for="add_title">نام واحد کالا</label>
            ...
            <div class="modal-footer">
                <div>
                    ...
                    <button type="button" class="btn btn-primary addProductNoUnit">تأیید</button>
                </div>
            </div>
        </div>
    </div>
...
@push('js')
    <script>
        $(document).ready(function() {
            $(document).on('click', '.addProductNoUnit', function(e) {
                e.preventDefault();
