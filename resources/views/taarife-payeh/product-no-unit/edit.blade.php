    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editInfoLabel">ویرایش واحد شمارش کالا</h5>
            ...
            <div class="modal-body">
                <div class="row">
                    <input type="hidden" id="edit_product_no_unit_id">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="form-group mb-3">
                            <label for="edit_code">کد واحد</label>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="form-group mb-3">
                            <div class="form-group mb-3">
                                <label for="edit_title">نام واحد کالا</label>
                                <input type="text" id="edit_title" name="edit_title" class="form-control"
                                    autocomplete="off" />
                                <div id="edit_title_error" class="invalid-feedback"></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary updateProductNoUnit">تأیید</button>
            </div>
        </div>
    </div>
</div>
...
@push('js')
    <script>
        $(document).on('click', '.edit_product_no_unit', function(e) {
            e.preventDefault();
            ...
            $.ajax({
                type: "GET",
                url: "/product-no-unit/" + product_no_unit_id + "/edit",
        ...
        $(document).on("click", ".updateProductNoUnit", function(e) {
            ...
            $.ajax({
                type: "PUT",
                url: "/product-no-unit/" + product_no_unit_id,
                data: data,
                dataType: "json",
                success: function(response) {
                    // console.log(response);
