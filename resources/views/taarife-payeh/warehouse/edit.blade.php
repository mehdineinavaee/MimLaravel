    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editInfoLabel">ویرایش انبار</h5>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="form-group mb-3">
                            <label for="edit_code">کد انبار</label>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="form-group mb-3">
                            <div class="form-group mb-3">
                                <label for="edit_title">نام انبار</label>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary updateWarehouse">تأیید</button>
            </div>
        </div>
    </div>
</div>
