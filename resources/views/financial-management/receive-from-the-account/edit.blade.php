    ...
    <div class="modal-dialog modal-dialog-centered"style="max-width: 900px;">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editInfoLabel">ویرایش دریافت از طرف حساب</h5>
            ...
            <div class="modal-body" style="min-height: 330px">
                <input type="hidden" id="edit_receive_from_the_account_id">
                <!-- Tabs content -->
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary updateReceiveFromTheAccount">تأیید</button>
            </div>
        </div>
    </div>
</div>
...
@push('js')
    <script>
        $(document).on('click', '.edit_receive_from_the_account', function(e) {
            e.preventDefault();
            ...
            $.ajax({
                type: "GET",
                url: "/receive-from-the-account/" + receive_from_the_account_id + "/edit",
        ...
        $(document).on("click", ".updateReceiveFromTheAccount", function(e) {
            ...
            $.ajax({
                type: "PUT",
                url: "/receive-from-the-account/" + receive_from_the_account_id,
                data: data,
                dataType: "json",
                success: function(response) {
                    // console.log(response);
