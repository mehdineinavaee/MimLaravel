    ...
    <div class="modal-dialog modal-dialog-centered"style="min-width: 50%;">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createInfoLabel">پرداخت شرکاء (سرمایه گذاری)</h5>
            ...
            <div class="row m-4">
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="form-group mb-3">
                        <label for="add_shareholder">نام سهام دار</label>
                        ...
                        <div id="add_shareholder_error" class="invalid-feedback"></div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="form-group mb-3">
            ...
            <div class="modal-body" style="min-height: 315px">
                ...
                <fieldset class="show" id="add_tab011">
                    <div class="row pt-4">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="form-group mb-3">
                                <label for="add_cash_register">نام صندوق</label>
                                <input type="text" id="add_cash_register" name="add_cash_register"
                                    class="form-control" autocomplete="off" />
                                <div id="add_cash_register_error" class="invalid-feedback"></div>
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="form-group mb-3">
            ...
            <div class="modal-footer">
                <div>
                    ...
                    <button type="button" class="btn btn-primary addInvestment">تأیید</button>
                </div>
            </div>
        </div>
    </div>
...
@push('js')
    <script>
        $(document).ready(function() {
            $(document).on('click', '.addInvestment', function(e) {
                e.preventDefault();
                var data = {
                    'shareholder': $('#add_shareholder').val(),
                    'form_date': $('#add_form_date').val(),
                    'cash_amount': $('#add_cash_amount').val(),
                    'cash_register': $('#add_cash_register').val(),
        ...
        function add_clearErrors() {
            $("#add_shareholder_error").text("");
            $("#add_shareholder").removeClass("is-invalid");
            ...
            $("#add_cash_register_error").text("");
            $("#add_cash_register").removeClass("is-invalid");
        ...
        function add_defaultSelectedValue() {
            $(add_shareholder).prop('selectedIndex', 0).change();
