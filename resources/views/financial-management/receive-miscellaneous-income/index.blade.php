        ...
        <div class="card-header">
            <h3 class="card-title">
                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#createInfo">
                    <span data-toggle="tooltip" data-placement="left" title="افزودن دریافت درآمد متفرقه">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-lg-2 col-md-2 col-sm-12">
                    <select id="index_row"
                        onChange="fetchDataAsPaginate('index_search','/receive-miscellaneous-income',1,this.value,'index_count','myData','index_pagination')"
            ...
            <table class="table-responsive table table-hover table-bordered table-striped" style="text-align: center;">
                <thead>
                    <tr>
                        ...
                        <th style="min-width: 200px">عنوان درآمد</th>
            ...
            $('#index_search').on('keyup', function() {
                ...
                serach_data
                    (
                        value,
                        row,
                        "/index-search-receive-miscellaneous-income",
                        "myData",
                        "index_pagination"
                    );
            });
