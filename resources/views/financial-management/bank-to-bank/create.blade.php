    ...
    <div class="modal-dialog modal-dialog-centered"style="max-width: 700px;">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createInfoLabel">از بانک به بانک جدید</h5>
            ...
            <div class="row m-4">
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="form-group mb-3">
                        <label for="add_from_bank">از بانک</label>
                        <select id="add_from_bank" name="add_from_bank" class="form-control select2"
                            style="width: 100%;">
                        ...
                        <div id="add_from_bank_error" class="invalid-feedback"></div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="form-group mb-3">
                        <label for="add_to_bank">به بانک</label>
                        <select id="add_to_bank" name="add_to_bank" class="form-control select2" style="width: 100%;">
                            <option value="" selected>بانک را انتخاب کنید</option>
                            @foreach ($banks_types as $banks_type)
                                <option value={{ $banks_type->id }}>
                                    {{ $banks_type->bank_name }}
                        ...
                        <div id="add_to_bank_error" class="invalid-feedback"></div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="form-group mb-3">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary addBankToBank">تأیید</button>
            </div>
        </div>
    </div>
</div>
...
@push('js')
    <script>
        $(document).ready(function() {
            $(document).on('click', '.addBankToBank', function(e) {
                e.preventDefault();

                var data = {
                    'from_bank': $('#add_from_bank').val(),
                    'to_bank': $('#add_to_bank').val(),
        ...
        function add_clearErrors() {
            $("#add_from_bank_error").text("");
            $("#add_from_bank").removeClass("is-invalid");
            $("#add_to_bank_error").text("");
            $("#add_to_bank").removeClass("is-invalid");
        ...
        function add_defaultSelectedValue() {
            $(add_from_bank).prop('selectedIndex', 0).change();
            $(add_to_bank).prop('selectedIndex', 0).change();
