    ...
    <div class="modal-dialog modal-dialog-centered"style="max-width: 900px;">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createInfoLabel">پرداخت هزینه جدید</h5>
            ...
            <div class="row m-4">
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="form-group mb-3">
                        <label for="add_cost_title">عنوان هزینه</label>
                        <select id="add_cost_title" name="add_cost_title" class="form-control select2"
                            style="width: 100%;">
                        ...
                        <div id="add_cost_title_error" class="invalid-feedback"></div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="form-group mb-3">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary addPay">تأیید</button>
            </div>
        </div>
    </div>
</div>
...
@push('js')
    <script>
        ...
        function add_clearErrors() {
            $("#add_cost_title_error").text("");
            $("#add_cost_title").removeClass("is-invalid");
        ...
        function add_defaultSelectedValue() {
            $(add_cost_title).prop('selectedIndex', 0).change();
