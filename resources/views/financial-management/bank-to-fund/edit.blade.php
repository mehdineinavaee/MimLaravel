    ...
    <div class="modal-dialog modal-dialog-centered"style="max-width: 700px;">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editInfoLabel">ویرایش از بانک به صندوق</h5>
            ...
            <div class="modal-body" style="min-height: 330px">
                <input type="hidden" id="edit_bank_to_fund_id">
                <!-- Tabs content -->
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary updateBankToFund">تأیید</button>
            </div>
        </div>
    </div>
</div>
...
@push('js')
    <script>
        $(document).on('click', '.edit_bank_to_fund', function(e) {
            e.preventDefault();
            ...
            $.ajax({
                type: "GET",
                url: "/bank-to-fund/" + bank_to_fund_id + "/edit",
        ...
        $(document).on("click", ".updateBankToFund", function(e) {
            ...
            $.ajax({
                type: "PUT",
                url: "/bank-to-fund/" + bank_to_fund_id,
                data: data,
                dataType: "json",
                success: function(response) {
                    // console.log(response);
