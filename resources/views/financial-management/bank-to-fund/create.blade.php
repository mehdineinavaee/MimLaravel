    ...
    <div class="modal-dialog modal-dialog-centered"style="min-width: 60%;">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createInfoLabel">از بانک به صندوق جدید</h5>
            ...
            <div class="modal-footer">
                <div>
                    ...
                    <button type="button" class="btn btn-primary addBankToFund">تأیید</button>
                </div>
            </div>
        </div>
    </div>
...
@push('js')
    <script>
        $(document).ready(function() {
            $(document).on('click', '.addBankToFund', function(e) {
                e.preventDefault();
