...
@section('content')
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-lg-2 col-md-2 col-sm-12">
                    <select id="index_row"
                        onChange="fetchDataAsPaginate('index_search','/taraf-hesab-period',1,this.value,'index_count','myData','index_pagination')"
    ...
    @include('first-period.taraf-hesab-period.create')
    @include('first-period.taraf-hesab-period.edit')
            ...
            $('#index_search').on('keyup', function() {
                ...
                serach_data
                    (
                        value,
                        row,
                        "/index-search-taraf-hesab-period",
                        "myData",
                        "index_pagination"
                    );
            });
