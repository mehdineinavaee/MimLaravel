...
@section('content')
        ...
        <div class="card-header">
            <h3 class="card-title">
                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#createInfo">
                    <span data-toggle="tooltip" data-placement="left" title="افزودن سند مالی">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-lg-2 col-md-2 col-sm-12">
                    <select id="index_row"
                        onChange="fetchDataAsPaginate('index_search','/fund-period',1,this.value,'index_count','myData','index_pagination')"
            ...
            <table class="table-responsive table table-hover table-bordered table-striped" style="text-align: center;">
                <thead>
                    <tr>
                        ...
                        <th style="min-width: 200px">نام صندوق</th>
                        <th style="min-width: 200px">مانده</th>
    ...
    @include('first-period.fund-period.create')
    @include('first-period.fund-period.edit')
