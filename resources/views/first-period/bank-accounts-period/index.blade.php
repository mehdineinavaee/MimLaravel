...
@section('content')
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-lg-2 col-md-2 col-sm-12">
                    <select id="index_row"
                        onChange="fetchDataAsPaginate('index_search','/bank-accounts-period',1,this.value,'index_count','myData','index_pagination')"
    ...
    @include('first-period.bank-accounts-period.create')
    @include('first-period.bank-accounts-period.edit')
            ...
            $('#index_search').on('keyup', function() {
                ...
                serach_data
                    (
                        value,
                        row,
                        "/index-search-bank-accounts-period",
                        "myData",
                        "index_pagination"
                    );
            });
