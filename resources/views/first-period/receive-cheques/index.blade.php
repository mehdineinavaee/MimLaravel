...
@section('content')
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-lg-2 col-md-2 col-sm-12">
                    <select id="index_row"
                        onChange="fetchDataAsPaginate('index_search','/receive-cheques',1,this.value,'index_count','myData','index_pagination')"
    ...
    @include('first-period.receive-cheques.create')
    @include('first-period.receive-cheques.edit')
