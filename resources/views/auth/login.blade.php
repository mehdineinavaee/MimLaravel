                ...
                <div class="col">
                    <div class="col form-group">
                        ...
                        <input type="email" placeholder="ایمیل را وارد کنید" id="email"
                            class="form-control inputs @error('email') is-invalid @enderror" name="email"
                    ...
                    <div class="col form-group">
                        ...
                        <input type="password" placeholder="رمز عبور را وارد کنید" id="password"
                            class="form-control inputs @error('password') is-invalid @enderror" name="password"
                            required>
                        @error('password')
                            <span class="invalid-feedback" role="alert">
                                {{ $message }}
                    ...
                    <h6>
                        ساخته شده توسط
                        <a href="https://irappco.ir/" target="_blank">
                            ایران اپ کو
                        </a>
                    </h6>
                </div>
