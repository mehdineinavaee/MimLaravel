@extends('layout.app')
@section('title', 'گزارش موجودی ریالی به تفکیک انبار')
@section('content')
    @include('common.breadcrumbs', [
        'data' => [['title' => 'گزارش موجودی ریالی به تفکیک انبار', 'url' => url()->current()]],
    ])
            ...
            <table class="table-responsive table table-hover table-bordered table-striped" style="text-align: center;">
                ...
                <tfoot>
                    <tr>
                        ...
                        <th>نام انبار</th>
                        <th>موجودی انبار</th>
                        <th>مبلغ میانگین خرید</th>
                        <th>مبلغ آخرین خرید</th>
                        <th>مبلغ کل</th>
                    </tr>
                </tfoot>
            </table>
...
@push('js')
    <script>
        ...
        $(document).on('click', '.riali_report_print', function(e) {
            e.preventDefault();
            var riali_report_print_id = $(this).val();
            // console.log(investory_warehouse_print_id);

            $.ajax({
                type: "GET",
                url: "/riali-report-print-pdf/" + riali_report_print_id,
            });
        });
    </script>
@endpush
