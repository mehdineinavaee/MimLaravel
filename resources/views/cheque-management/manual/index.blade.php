        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-lg-2 col-md-2 col-sm-12">
                    <select id="index_row"
                        onChange="fetchDataAsPaginate('index_search','/manual',1,this.value,'index_count','myData','index_pagination')"
            ...
            <table class="table-responsive table table-hover table-bordered table-striped" style="text-align: center;">
                <thead>
                    <tr>
                        <th colspan="12" style="background-color: azure; color:blue;">لیست فرم های چک های وصول شده دستی
                        </th>
                    </tr>
                    <tr>
                        <th colspan="3" style="background-color: beige; color:red;">مشخصات فرم</th>
                        <th colspan="9" style="background-color: beige; color:red;">مشخصات چک های موجود در فرم</th>
                    </tr>
                    <tr>
                        ...
                        <th style="min-width: 200px">واریز به</th>
