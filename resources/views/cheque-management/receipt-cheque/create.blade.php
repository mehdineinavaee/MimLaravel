    ...
    <div class="modal-dialog modal-dialog-centered" style="min-width: 700px">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createInfoLabel">اعلام وصول چک جدید</h5>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="form-group mb-3">
                            <label for="add_receiver">دریافت کننده</label>
                            <input type="text" id="add_receiver" name="add_receiver" class="form-control"
                                autocomplete="off" />
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary addReceiptCheque">تأیید</button>
            </div>
        </div>
    </div>
</div>
...
@push('js')
    <script>
        $(document).ready(function() {
            $(document).on('click', '.addReceiptCheque', function(e) {
                e.preventDefault();
