...
@push('js')
    <script>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.status == 404) {
                        ...
                        $("#edit_total").val(response.pay_returning_cheque.total);
                        $("#edit_wage").val(response.pay_returning_cheque.wage);
        ...
        $(document).on("click", ".updatePayReturningCheque", function(e) {
            ...
            var data = {
                pay_returning_cheque_id: $("#edit_pay_returning_cheque_id").val(),
