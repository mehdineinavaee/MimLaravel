    ...
    <div class="modal-dialog modal-dialog-centered" style="min-width: 700px">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createInfoLabel">خواباندن چک جدید به حساب</h5>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="form-group mb-3">
                            <label for="add_place">محل خواباندن چک</label>
                            <input type="text" id="add_place" name="add_place" class="form-control"
                                autocomplete="off" />
                            <div id="add_place_error" class="invalid-feedback"></div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="form-group mb-3">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="add_due_date" name="add_due_date"
                                    class="leftToRight rightAlign inputMaskDate form-control" autocomplete="off" />
                                <div id="add_due_date_error" class="invalid-feedback" style="margin-right:38px;">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-footer">
                <div>
                    ...
                    <button type="button" class="btn btn-primary addDeposit">تأیید</button>
                </div>
            </div>
        </div>
    </div>
...
@push('js')
    <script>
        ...
        function add_clearErrors() {
            ...
            $("#add_place_error").text("");
            $("#add_place").removeClass("is-invalid");
