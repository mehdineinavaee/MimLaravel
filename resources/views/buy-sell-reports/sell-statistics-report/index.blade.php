@extends('layout.app')
@section('title', 'گزارش آماری فروش بر اساس کالا')
@section('content')
    @include('common.breadcrumbs', [
        'data' => [['title' => 'گزارش آماری فروش بر اساس کالا', 'url' => url()->current()]],
    ])
                        ...
                        <div class="row pt-4">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="form-group mb-3">
                                    ...
                                    <select id="index_factor_group" name="index_factor_group"
                                        class="form-control select2" style="width: 100%;">
            ...
            <table class="table-responsive table table-bordered table-striped" style="text-align: center; width: 100%">
                <thead>
                    <tr style="background-color: #f8f9fa">
                        <th colspan="9">
                            لیست خریدارهای کالا:
                            <label for="index_taraf_hesab_factors_list">Empty</label>
                        </th>
                    </tr>
                    <tr>
...
@push('js')
    <script>
        fetchSellStatisticsReport();

        function fetchSellStatisticsReport() {
            $.ajax({
                type: "GET",
                url: "/fetch-sell-statistics-report",
                dataType: "json",
        ...
        $(document).on('click', '.sell_statistics_report_print', function(e) {
            e.preventDefault();
            var sell_statistics_report_print_id = $(this).val();
            // console.log(sell_statistics_report_print_id);

            $.ajax({
                type: "GET",
                url: "/sell-statistics-report-print-pdf/" + sell_statistics_report_print_id,
            });
        });
    </script>
@endpush
