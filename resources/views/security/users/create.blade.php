    ...
    <div class="modal-dialog modal-dialog-centered"style="min-width: 60%;">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createInfoLabel">کاربر جدید</h5>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="form-group mb-3">
                            <label for="add_role">نقش کاربر</label>
                            ...
                            <div id="add_role_error" class="invalid-feedback"></div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="form-group mb-3">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="form-group mb-3">
                            <label for="add_email">نام کاربری</label>
                            <input type="email" id="add_email" name="add_email" class="form-control"
                                autocomplete="off" placeholder="ایمیل را وارد کنید" />
                            <div id="add_email_error" class="invalid-feedback"></div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="form-group mb-3">
                            <label for="add_password">رمز عبور</label>
                            <input type="password" id="add_password" name="add_password" class="form-control"
                                autocomplete="off" />
                            <div id="add_password_error" class="invalid-feedback"></div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="form-group mb-3">
                            <label for="add_confirm_password">تکرار رمز عبور</label>
                            <input type="password" id="add_confirm_password" name="add_confirm_password"
                                class="form-control" autocomplete="off" />
                            <div id="add_confirm_password_error" class="invalid-feedback"></div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                <div>
                    ...
                    <button type="button" class="btn btn-primary addUser">تأیید</button>
                </div>
            </div>
        </div>
    </div>
...
@push('js')
    <script>
        ...
        function add_clearErrors() {
            ...
            $("#add_confirm_password_error").text("");
        ...
        function add_defaultSelectedValue() {
            ...
            $(add_role).prop('selectedIndex', 0).change();
        }
    </script>
@endpush
