...
@push('js')
    <script>
        ...
        $(document).on('click', '.pagination a', function(e) {
            ...
            fetchDataAsPaginate('add_invoice_search', '/fetch-sell-factor-advanced', page, row.value, 'add_count',
                'add_product_data', 'add_product_pagination')
        })

        fetchDataAsPaginate('add_invoice_search', '/fetch-sell-factor-advanced', 1, 10, 'add_count', 'add_product_data',
        ...
        $(document).ready(function() {
            $('#add_invoice_search').on('keyup', function() {
                ...
                serach_data(value, row, "/search-sell-factor-advanced", "add_product_data",
                    "add_product_pagination");
            });
        });
        // end search data
