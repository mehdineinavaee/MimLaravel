    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editInfoLabel">ویرایش فاکتور ضایعات</h5>
            ...
            <div class="modal-body">
                <div class="row">
                    <input type="hidden" id="edit_wastage_factor_id">
                    <div class="col-lg-12 col-md-12 col-sm-12" id="edit_hidden_div" style="display: none;">
                        <div class="form-group mb-3">
                            <button type="button" class="edit_collapsible">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12" id="edit_hidden_wastage_type" style="display: none;">
                        <div class="form-group mb-3">
                            <button type="button" class="edit_collapsible">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <div class="form-group mb-3">
                                                ...
                                                <select id="edit_customer_type" name="edit_customer_type"
                                                    class="form-control select2" style="width: 100%;"
                                                    onChange="editCustomerType('edit_hidden_div',this.value)">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <div class="form-group mb-3">
                                                ...
                                                <select id="edit_buyer" name="edit_buyer" class="form-control select2"
                                                    style="width: 100%;">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="form-group mb-3">
                            <label for="edit_wastage_type">نوع ضایعات</label>
                            <select id="edit_wastage_type" name="edit_wastage_type" class="form-control select2"
                                style="width: 100%;"
                                onChange="editWastageType('edit_hidden_wastage_type','edit_hidden_div',this.value)">
                            ...
                            <div id="edit_wastage_type_error" class="invalid-feedback"></div>
                        </div>
                    </div>
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="form-group mb-3">
            ...
            <div class="modal-footer" style="justify-content: space-between;">
                ...
                <div>
                    ...
                    <button type="button" class="btn btn-primary updateWastageFactor">تأیید</button>
                </div>
            </div>
        </div>
    </div>
...
<!-- End Modal -->
@include('buy-sell.wastage-factor-details.edit')
...
@push('js')
    <script>
        ...
        function editWastageType(divWastage, divCustomer, element) {
            if (element == 2) {
        ...
        $(document).on('click', '.edit_wastage_factor', function(e) {
            e.preventDefault();
            var wastage_factor_id = $(this).val();
            // console.log(wastage_factor_id);

            $.ajax({
                type: "GET",
                url: "/wastage-factor/" + wastage_factor_id + "/edit",
                success: function(response) {
                    ...
                    if (response.status == 404) {
                        ...
                        $("#edit_wastage_factor_id").val(wastage_factor_id);
                        $("#edit_national_code").val(response.wastage_factor.national_code);
                        $("#edit_viator").val(response.wastage_factor.viator);
                        $("#edit_tel").val(response.wastage_factor.tel);
                        $("#edit_address").val(response.wastage_factor.address);
                        $('#edit_wastage_type').val(response.wastage_factor.wastage_type)
                            .change();
                        $('#edit_customer_type').val(response.wastage_factor.customer_type)
                            .change();
                        $('#edit_buyer').val(response.wastage_factor.buyer_id).change();
                        $("#edit_factor_no").val(response.wastage_factor.factor_no);
                        $("#edit_factor_date").val(response.wastage_factor.factor_date);
                        $("#edit_commission").val(response.wastage_factor
                            .commission);
                        $("#edit_settlement_deadline").val(response.wastage_factor
                            .settlement_deadline);
                        $("#edit_settlement_date").val(response.wastage_factor
                            .settlement_date);
                    }
                },
            });
        ...
        $(document).on("click", ".updateWastageFactor", function(e) {
            e.preventDefault();
            var wastage_factor_id = $("#edit_wastage_factor_id").val();
            ...
            var data = {
                ...
                wastage_type: $('#edit_wastage_type').val(),
            ...
            $.ajax({
                type: "PUT",
                url: "/wastage-factor/" + wastage_factor_id,
                data: data,
                dataType: "json",
                success: function(response) {
                    // console.log(response);
        ...
        function edit_clearErrors() {
            ...
            $("#edit_wastage_type_error").text("");
            $("#edit_wastage_type").removeClass("is-invalid");
        ...
        function edit_defaultSelectedValue() {
            $(edit_wastage_type).prop('selectedIndex', 0).change();
            $(edit_customer_type).prop('selectedIndex', 0).change();
            $(edit_buyer).prop('selectedIndex', 0).change();
        }
    </script>
