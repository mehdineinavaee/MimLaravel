        ...
        <div class="card-header">
            <h3 class="card-title">
                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#createInvoice">
                    <span data-toggle="tooltip" data-placement="left" title="افزودن برگشت از فروش">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-12">
                        <select id="index_invoice_row"
                            onChange="fetchDataAsPaginate('index_invoice_search','/return-sell-factor',1,this.value,'index_count','myData','index_pagination')"
    ...
    <script>
            ...
            $('#index_invoice_search').on('keyup', function() {
                ...
                serach_data
                    (
                        value,
                        row,
                        "/index-search-return-sell-factors",
                        "myData",
                        "index_pagination"
                    );
            });
        ...
        $(document).ready(function() {
            $("#index_factors_table").on('click', '.indexRow', function() {
                ...
                var return_sell_factor_id = currentRow.find("td:eq(0)").html();
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.status == 404) {
                            ...
                            $('#selectData').html(response.return_sell_factor_by_id);
