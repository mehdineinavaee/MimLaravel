...
<!-- End Modal -->
@include('buy-sell.buy-factor-details.edit')
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.status == 404) {
                        ...
                        $("#edit_national_code").val(response.buy_factor.national_code);
                        $("#edit_viator").val(response.buy_factor.viator);
                        $("#edit_tel").val(response.buy_factor.tel);
                        $("#edit_address").val(response.buy_factor.address);
                        $('#edit_customer_type').val(response.buy_factor.customer_type).change();
                        $('#edit_seller').val(response.buy_factor.seller_id).change();
                        $("#edit_factor_no").val(response.buy_factor.factor_no);
                        $("#edit_factor_date").val(response.buy_factor.factor_date);
                        $('#edit_broker').val(response.buy_factor.broker_id).change();
                        $("#edit_commission").val(response.buy_factor
                            .commission);
                        $("#edit_settlement_deadline").val(response.buy_factor.settlement_deadline);
                        $("#edit_settlement_date").val(response.buy_factor
                            .settlement_date);
                    }
                },
            });
