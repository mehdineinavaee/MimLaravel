        ...
        <div class="card-body">
            <table class="table-responsive table table-bordered table-striped" style="text-align: center;">
                <thead>
                    <tr>
                        <th>ردیف</th>
                        <th style="min-width: 90px">نام خریدار</th>
                        <th style="min-width: 90px">برگشتی</th>
                        <th style="min-width: 90px">مبلغ</th>
                        <th style="min-width: 90px">مالیات ارزش افزوده</th>
                        <th style="min-width: 90px">عوارض شهرداری</th>
                        <th style="min-width: 90px">جمع</th>
