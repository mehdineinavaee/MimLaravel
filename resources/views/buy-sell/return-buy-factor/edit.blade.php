        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="form-group mb-3">
                            <label for="edit_seller">فروشنده</label>
                            <select id="edit_seller" name="edit_seller" class="form-control select2"
                                style="width: 100%;">
                            ...
                            <div id="edit_seller_error" class="invalid-feedback"></div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="form-group mb-3">
...
<!-- End Modal -->
@include('buy-sell.return-buy-factor-details.edit')
    ...
    <script>
        ...
        function editCustomerType(divId, element) {
            if (element == 2) {
                ...
                $(edit_seller).prop('selectedIndex', 0).change();
                document.getElementById("edit_seller").disabled = true;
                $("#edit_seller_error").text("");
                $("#edit_seller").removeClass("is-invalid");
            } else {
                document.getElementById(divId).style.display = 'none';
                document.getElementById("edit_seller").disabled = false;
            }
        }
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.status == 404) {
                        ...
                        $("#edit_national_code").val(response.return_buy_factor.national_code);
                        $("#edit_viator").val(response.return_buy_factor.viator);
                        $("#edit_tel").val(response.return_buy_factor.tel);
                        $("#edit_address").val(response.return_buy_factor.address);
                        $('#edit_customer_type').val(response.return_buy_factor.customer_type).change();
                        $('#edit_seller').val(response.return_buy_factor.seller_id).change();
                        $("#edit_factor_no").val(response.return_buy_factor.factor_no);
                        $("#edit_factor_date").val(response.return_buy_factor.factor_date);
                        $('#edit_broker').val(response.return_buy_factor.broker_id).change();
                        $("#edit_commission").val(response.return_buy_factor
                            .commission);
                        $("#edit_settlement_deadline").val(response.return_buy_factor
                            .settlement_deadline);
                        $("#edit_settlement_date").val(response.return_buy_factor
                            .settlement_date);
                    }
                },
            });
