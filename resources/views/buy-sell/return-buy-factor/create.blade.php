                ...
                <div class="row pt-4">
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="form-group mb-3">
                            <label for="add_return_buy_factor_no">شماره</label>
                            <input type="text" id="add_return_buy_factor_no" name="add_return_buy_factor_no"
                                class="form-control" autocomplete="off" />
                            <div id="add_return_buy_factor_no_error" class="invalid-feedback"></div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        $(document).ready(function() {
            $(document).on('click', '.addReturnBuyFactor', function(e) {
                ...
                var data = {
                    'return_buy_factor_no': $('#add_return_buy_factor_no').val(),
                }
                // console.log(data);
        ...
        function add_clearErrors() {
            $("#add_return_buy_factor_no_error").text("");
            $("#add_return_buy_factor_no").removeClass("is-invalid");
        }
    </script>
@endpush
