                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-12">
                        <select id="add_invoice_row"
                            onChange="fetchDataAsPaginate('add_invoice_search','/fetch-return-buy-factor',1,this.value,'add_count','add_product_data','add_product_pagination')"
...
@push('js')
    <script>
        ...
        $(document).on('click', '.pagination a', function(e) {
            ...
            fetchDataAsPaginate('add_invoice_search', '/fetch-return-buy-factor', page, row.value, 'add_count',
                'add_product_data', 'add_product_pagination')
        })

        fetchDataAsPaginate('add_invoice_search', '/fetch-return-buy-factor', 1, 10, 'add_count', 'add_product_data',
        ...
        $(document).ready(function() {
            $('#add_invoice_search').on('keyup', function() {
                ...
                serach_data(value, row, "/search-return-buy-factor", "add_product_data",
                    "add_product_pagination");
            });
        });
        // end search data
