    ...
    <div class="modal-dialog modal-dialog-centered" style="min-width:50%;">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createInfoLabel">ورود اطلاعات پیش فاکتور فروش</h5>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="form-group mb-3">
                            <label for="add_applicant">درخواست کننده</label>
                            <select id="add_applicant" name="add_applicant" class="form-control select2"
                                style="width: 100%;">
                            ...
                            <div id="add_applicant_error" class="invalid-feedback"></div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="form-group mb-3">
            ...
            <div class="modal-footer" style="justify-content: space-between;">
                ...
                <div>
                    ...
                    <button type="button" class="btn btn-primary addSellFactorAdvanced">تأیید</button>
                </div>
            </div>
        </div>
    </div>
...
<!-- End Modal -->
@include('buy-sell.sell-factor-advanced-details.create')
    ...
    <script>
        ...
        function addCustomerType(divId, element) {
            if (element == 2) {
                ...
                $(add_applicant).prop('selectedIndex', 0).change();
                document.getElementById("add_applicant").disabled = true;
                $("#add_applicant_error").text("");
                $("#add_applicant").removeClass("is-invalid");
            } else {
                document.getElementById(divId).style.display = 'none';
                document.getElementById("add_applicant").disabled = false;
        ...
        $(document).ready(function() {
            $(document).on('click', '.addSellFactorAdvanced', function(e) {
                e.preventDefault();
