        ...
        <div class="card-header">
            <h3 class="card-title">
                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#createInvoice">
                    <span data-toggle="tooltip" data-placement="left" title="افزودن فاکتور فروش">
    ...
    <script>
        ...
        $(document).ready(function() {
            $("#index_factors_table").on('click', '.indexRow', function() {
                ...
                var sell_factor_id = currentRow.find("td:eq(0)").html();
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.status == 404) {
                            ...
                            $('#selectData').html(response.sell_factor_by_id);
