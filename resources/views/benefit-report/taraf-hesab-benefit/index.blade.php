            ...
            <table class="table-responsive table table-hover table-bordered table-striped" style="text-align: center;">
                <thead>
                    <tr>
                        ...
                        <th style="min-width: 100px">کد طرف حساب</th>
...
@push('js')
    <script>
        ...
        $(document).on('click', '.taraf_hesab_benefit_print', function(e) {
            e.preventDefault();
            var taraf_hesab_benefit_print_id = $(this).val();
            // console.log(taraf_hesab_benefit_print_id);

            $.ajax({
                type: "GET",
                url: "/taraf-hesab-benefit-print-pdf/" + taraf_hesab_benefit_print_id,
            });
        });
    </script>
@endpush
